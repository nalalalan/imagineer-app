...
DEFAULT_STATE: dict[str, Any] = {
    ...
    "target": {
        ...
        "active_listing_posted": "2026-08-10",
        "active_listing_url": VERIFIED_DISNEY_JOB_URL,
        "active_listing_state": "unavailable_on_last_check",
        "active_listing_last_checked_at": "2026-08-31T09:11:52-04:00",
        "active_listing_last_status_code": 404,
        "active_listing_note": "Disney Careers destination returned HTTP 404 on the clicked page. Use the search target; no current lead is verified.",
    ...
    def _next_action(
        ...
        actions = {
            "mechanical_depth": {
                ...
                "why": "The WDI mechanical R&D search target centers mechanical SME judgment, design review, safety, reliability, standards, kinematics, machine design, FEA/CAD, and prototype/development work.",
            },
            "creative_prototyping": {
                "lane": key,
