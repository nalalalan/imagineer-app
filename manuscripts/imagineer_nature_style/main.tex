...
\centering
\small
\caption{State variables at the current evidence lock. Values are reported from the live operations endpoint, the published weekly-paper snapshot on 1 June 2026, and the Progress summary scan on 1 June 2026 at 7:35 AM Eastern.}
\label{tab:state}
