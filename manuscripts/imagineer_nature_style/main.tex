...
\centering
\small
\caption{State variables at the current evidence lock. Values are reported from the live operations endpoint, the published weekly-paper snapshot on 18 May 2026, and the Progress scan on 19 May 2026.}
\label{tab:state}
...
Progress source registry & The live public profile displays 41 tracked sources from the Progress scan; the Imagineer operations profile and latest AI-review count remain 33 sources. Private source text remains summarized by status and freshness rather than mirrored publicly \\
...
Source count & 33 sources in the latest recorded AI review and Imagineer operations profile count; 41 sources in the live public profile's Progress-backed source line; no fresh AI review was run in the 18 May weekly snapshot \\
