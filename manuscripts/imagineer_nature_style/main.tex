...
\centering
\small
\caption{State variables at the current evidence lock. Values are reported from the live operations endpoint, the published 2026-W24 weekly-paper snapshot, and the Progress summary scan on 13 June 2026 at 9:12 AM Eastern.}
\label{tab:state}
...
Weekly snapshot & 2026-W24; status \texttt{published\_paper\_snapshot}; latest verified live refresh remained 12 June 2026 because the 13 June deploy was blocked before the weekly endpoint could run \\
...
Counters & Seven work-event logs; zero outreach events; one daily cycle; fifteen AI-review records; four portfolio anchors; five profile-prepared artifacts; thirty-three journal entries in the live operations state at the 13 June source read \\
