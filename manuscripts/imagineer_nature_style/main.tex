...
\centering
\small
\caption{State variables at the current evidence lock. Values are reported from the live operations endpoint, the published 2026-W24 weekly-paper snapshot, and the Progress summary scan on 11 June 2026 at 9:12 AM Eastern.}
\label{tab:state}
...
Weekly snapshot & 2026-W24; status \texttt{published\_paper\_snapshot}; refreshed during the 11 June 2026 morning profile run \\
...
Counters & Seven work-event logs; zero outreach events; one daily cycle; fifteen AI-review records; four portfolio anchors; five profile-prepared artifacts; thirty-one journal entries in the weekly-paper snapshot metrics, followed by thirty-two in the live operations state after the 11 June weekly-paper refresh \\
