...
\centering
\small
\caption{State variables at the current evidence lock. Values are reported from the live system and code state after the 15 May 2026 single-step and Progress-source update.}
\label{tab:state}
...
Profile freshness & Public profile exposes the live read timestamp, Progress source-count, fit score, bottleneck score, current system action, and six role-fit lanes; the Imagineer home page shows only the current step \\
