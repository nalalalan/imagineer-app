...
\centering
\small
\caption{State variables at the current evidence lock. Values are reported from the live operations endpoint, the current 2026-W25 weekly-paper preview, and the Progress summary scan on 17 June 2026 at 9:13 AM Eastern.}
\label{tab:state}
...
Weekly snapshot & 2026-W25; status \texttt{live\_preview\_until\_paper\_snapshot}; live weekly endpoint generated the 17 June 2026 preview, and the public PDF route carries the deployed manuscript snapshot for this evidence lock \\
...
Counters & Seven work-event logs; zero outreach events; one daily cycle; fifteen AI-review records; four portfolio anchors; five profile-prepared artifacts; thirty-three journal entries in the live operations state at the 17 June source read \\
