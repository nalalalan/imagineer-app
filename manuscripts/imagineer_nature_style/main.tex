...
Fit score & 85 of 100 with strong-and-visible confidence \\
...
The system-level fit score increased to 85 of 100, but this should be interpreted as improved instrumentation and artifact readiness, not as an external hiring probability. The reviewer result is deliberately stricter than the system score. It confirms that the overall direction is credible for WDI R\&D while rejecting the idea that the current public packet is already principal-level proof.
...
Glendale packet & 100 & Strong internal readiness score, but the public packet still needs a denser reviewer-proof technical artifact. \\
