...
\centering
\small
\caption{State variables at the current evidence lock. Values are reported from the live operations endpoint, the published weekly-paper snapshot on 1 June 2026, and the Progress summary scan on 9 June 2026 at 5:12 AM Eastern.}
\label{tab:state}
...
Weekly snapshot & 2026-W23; status \texttt{published\_paper\_snapshot}; updated 1 June 2026 at 8:33 AM Eastern \\
