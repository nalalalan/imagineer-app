...
- Serves a source-backed WDI R&D profile at `profile.html`.
- Tracks target-role fit, source review, experiments, journal entries, and guardrails.
...
- Paper continuity rule: any substantive change to the dashboard, backend, reviewer policy, source graph, public profile, metrics, guardrails, or paper-backed evidence must update the manuscript source and PDF in the same work cycle.
